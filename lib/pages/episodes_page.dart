  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<EpisodesFromSeason>?>(
        future: NyaaShows.trakt
            .episodesFromSeason(id: show.ids!.trakt, season: season.number),
                  ...
                  return SizedBox(
                      ...
                      child: Center(
                        child: TextButton(
                            onPressed: () {
                              NyaaShows.trakt
                                  .episodeFromNumber(
                                      ...
                                      episode: snapshot.data![index].number)
                                  .then((episode) {
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => TorrentLinks(
                                              torrentEpisode: TorrentEpisode(
                                                  ...
                                                  episodeId: snapshot
                                                      .data![index].number,
                                                  episodeName: snapshot
                                                      .data![index].title,
                                                  seasonName: season.title,
                                                  showYear: show.year!,
                                                  episodeYear:
                                                      episode.firstAired.year,
                                                  tvdb: snapshot
                                                      .data![index].ids.tvdb!),
                                            )));
                              });
                            ...
                            child: Text(
                                'S${snapshot.data![index].season}:E${snapshot.data![index].number} - ${snapshot.data![index].title}')),
                      ));
                });
