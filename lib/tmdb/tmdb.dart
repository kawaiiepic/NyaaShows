...
import 'package:nyaashows/tmdb/json/images.dart';


class TMDB {
  Future<String> poster(int id) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (images.posters != null && images.posters!.isNotEmpty) return 'https://image.tmdb.org/t/p/original${images.posters![0].filePath!}';
    }
