...
TvdbArtwork tvdbArtworkFromJson(String str) => TvdbArtwork.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        slug: json["slug"],
        image: json["image"],
        nameTranslations: List<String>.from(json["nameTranslations"].map((x) => x)),
        overviewTranslations: List<String>.from(json["overviewTranslations"].map((x) => x)),
        ...
        year: json["year"],
        artworks: List<Artwork>.from(json["artworks"].map((x) => Artwork.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "overviewTranslations": List<dynamic>.from(overviewTranslations.map((x) => x)),
        ...
        "lastAired": "${lastAired.year.toString().padLeft(4, '0')}-${lastAired.month.toString().padLeft(2, '0')}-${lastAired.day.toString().padLeft(2, '0')}",
        "nextAired": nextAired,
        "score": score,
